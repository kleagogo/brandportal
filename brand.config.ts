...
const config: BrandConfig = {
  ...
  sections: [
    ...
    { id: 'studio',       label: 'Pitho Studio',      type: 'subbrand',   icon: 'heart',       group: 'subbrands' },
    { id: 'email-sig',    label: 'Email Signature',   type: 'link',       icon: 'mail',        group: 'tools',      url: 'https://pitho.io/email-signature' },
    { id: 'new-member',   label: 'New Team Member',   type: 'link',       icon: 'person',      group: 'tools',      url: 'https://pitho.io/onboarding' },
